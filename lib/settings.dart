...
class _SettingsPageState extends State<SettingsPage> {
                ...
                children: <Widget>[
                  ...
                  Text('Github Link can be found in About App Section.',
                      style: TextStyle(
                          ...
                          fontSize: 14,
                          color: Colors.black54)),
                  Text('Note: You need to be signed to your GoogleAccount to report bug and give app review,this helps in keeping track of app review counts ad bug reports. ',
                      style: TextStyle(
                          fontFamily: 'Montserrat',
                          fontSize: 14,
                          color: Colors.black)),
  ...
  void appreview() {
    launch('https://forms.gle/YZaSUS4shQ6zT2cy6');
  }
  void bugreport(){
    launch('https://forms.gle/xmCWM4Vsw8urowEfA');
  }
